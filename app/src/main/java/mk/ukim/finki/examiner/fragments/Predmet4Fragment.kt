...
import mk.ukim.finki.examiner.data.bizList

class Predmet4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_predmet4, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mutable: MutableList<Predmet> = bizList()
        mutable.shuffle()
        var counter: Int = 0
        var poeni: Int = 0
...
//                }
    ...
    fun uploadData(poeni: Int){
        ...
        if (userUID != null) {
            FirebaseDatabase.getInstance().getReference("Бизнис и менаџмент").child(userUID).setValue(data)
        }
    }
}